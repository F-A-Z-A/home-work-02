...
function Clock() {
  ...
  const stringTime = new Intl
    .DateTimeFormat("ru", {hour: "2-digit", minute: "2-digit", second: "2-digit"})
    .format(date) || <br/>
  
  const stringDate = new Intl
    .DateTimeFormat("ru", {day: "2-digit", month: "2-digit", year: "numeric"})
    .format(date) || <br/>
  
  const stringDay = new Intl
    .DateTimeFormat("en", {weekday: "long"})
    .format(date) || <br/>
  
  const stringMonth = new Intl
